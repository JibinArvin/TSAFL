...
$ROOT_DIR/tool/TSAFL/CUR-clang-fast  -g -c ./df.c -o df.o # -fsanitize=address 
clang++ ./df.o $ROOT_DIR/tool/TSAFL/Currency-instr.o -g -o df -lpthread -ldl # -fsanitize=address
