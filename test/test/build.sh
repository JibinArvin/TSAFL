...
$ROOT_DIR/tool/TSAFL/CUR-clang-fast -g  -O0 -c ./test.c -o test.o # -fsanitize=thread
clang++ ./test.o $ROOT_DIR/tool/TSAFL/Currency-instr.o -g -o test -lpthread -ldl # -fsanitize=thread
